...
public final class SuratSakit extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnCetakSuratSakit5.setText("Cetak Surat Sakit");
        ...
        TanggalAkhir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "20-02-2023" }));
        ...
        TanggalAwal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "20-02-2023" }));
...
//            finger=Sequel.cariIsi("select sha1(sidikjari.sidikjari) from sidikjari inner join pegawai on pegawai.id=sidikjari.id where pegawai.nik=?",kodedokter);
//            param.put("finger","Dikeluarkan di "+akses.getnamars()+", Kabupaten/Kota "+akses.getkabupatenrs()+"\nDitandatangani secara elektronik oleh "+namadokter+"\nID "+(finger.equals("")?kodedokter:finger)+"\n"+Sequel.cariIsi("select DATE_FORMAT(reg_periksa.tgl_registrasi,'%d-%m-%Y') from reg_periksa where reg_periksa.no_rawat=?",TNoRw.getText())); 
            finger=Sequel.cariIsi("select no_surat from suratsakit where no_rawat = ?", TNoRw.getText());
            String no_surat = finger;
            param.put("finger", "http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/surat/SuratSakit.php?no_surat="+getMd5(no_surat));
            Valid.MyReportqry("rptSuratSakit4.jasper","report","::[ Surat Sakit ]::",
                      "select reg_periksa.no_rawat,reg_periksa.kd_dokter,dokter.nm_dokter,pasien.keluarga,pasien.namakeluarga,pasien.tmp_lahir,pasien.tgl_lahir,pasien.jk,DATE_FORMAT(reg_periksa.tgl_registrasi,'%d-%m-%Y')as tgl_registrasi," +
