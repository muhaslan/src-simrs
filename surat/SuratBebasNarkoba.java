...
public final class SuratBebasNarkoba extends javax.swing.JDialog {
    ...
    public SuratBebasNarkoba(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Surat Sakit","No.Rawat","No.R.M.","Nama Pasien","Tanggal Surat","Kategori","KD Dokter","Dokter","Petugas","Keperluan",
...
//                column.setPreferredWidth(70);
        ...
        petugas.addWindowListener(new WindowListener(){
            ...
            public void windowClosed(WindowEvent e) {
                if (petugas.getTable().getSelectedRow()!= -1){
                    TDokter2.setText(petugas.getTable().getValueAt(petugas.getTable().getSelectedRow(),0).toString());
                }
    ...
    private void initComponents() {
        ...
        TanggalSurat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "20-02-2023" }));
        ...
        jLabel20.setBounds(30, 130, 135, 23);
        ...
        hasil1.setBounds(170, 100, 100, 23);
        ...
        jLabel23.setBounds(30, 100, 135, 23);
        ...
        hasil2.setBounds(170, 130, 100, 23);
        ...
        jLabel26.setBounds(510, 100, 95, 23);
        ...
        hasil4.setBounds(390, 130, 100, 23);
        ...
        hasil3.setBounds(390, 100, 100, 23);
        ...
        hasil5.setBounds(610, 100, 100, 23);

        jLabel27.setText("Cocain :");
        jLabel27.setName("jLabel27"); // NOI18N
        FormInput.add(jLabel27);
        jLabel27.setBounds(510, 130, 95, 23);
        ...
        hasil6.setBounds(610, 130, 100, 23);
        ...
        KdDok1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                KdDok1ActionPerformed(evt);
            }
        });
        FormInput.add(KdDok1);
        KdDok1.setBounds(74, 70, 99, 23);

        TDokter1.setEditable(false);
        TDokter1.setHighlighter(null);
        TDokter1.setName("TDokter1"); // NOI18N
        TDokter1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TDokter1ActionPerformed(evt);
            }
        });
        TDokter1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TDokter1KeyPressed(evt);
            }
        });
        FormInput.add(TDokter1);
        TDokter1.setBounds(175, 70, 204, 23);
        ...
        btnDokter1.setBounds(382, 70, 28, 23);

        jLabel9.setText("Petugas :");
        jLabel9.setName("jLabel9"); // NOI18N
        FormInput.add(jLabel9);
        jLabel9.setBounds(700, 70, 70, 23);
        ...
        TDokter2.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TDokter2KeyPressed(evt);
            }
        });
        FormInput.add(TDokter2);
        TDokter2.setBounds(780, 70, 204, 23);
        ...
        btnDokter2.setBounds(985, 70, 28, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        if(NoSurat.getText().trim().equals("")){
            ...
            Valid.textKosong(TDokter2,"Petugas");
            ...
            if(Sequel.menyimpantf("surat_skbn","?,?,?,?,?,?,?,?,?,?,?,?,?","No.Surat SKBN",13,new String[]{
                    NoSurat.getText(),TNoRw.getText(),Valid.SetTgl(TanggalSurat.getSelectedItem()+""),Kategori.getSelectedItem().toString(),KdDok.getText(),TDokter2.getText(),Keperluan.getText(),hasil1.getSelectedItem().toString(),hasil2.getSelectedItem().toString(),hasil3.getSelectedItem().toString(),
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        ...
        if(NoSurat.getText().trim().equals("")){
            ...
            if(tbObat.getSelectedRow()!= -1){
                if(Sequel.mengedittf("surat_skbn","no_surat=?","no_surat=?,no_rawat=?,tanggalsurat=?,kategori=?,kd_dokter=?,petugas=?,keperluan=?,opiat=?,ganja=?,amphetamin=?,methamphetamin=?,benzodiazepin=?,cocain=?",14,new String[]{
                    NoSurat.getText(),TNoRw.getText(),Valid.SetTgl(TanggalSurat.getSelectedItem()+""),Kategori.getSelectedItem().toString(),KdDok.getText(),TDokter2.getText(),Keperluan.getText(),hasil1.getSelectedItem().toString(),
    ...
    private void MnCetakSuratSKBN3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratSKBN3ActionPerformed
        if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                param.put("petugas",TDokter2.getText());
...
//              new code is here
                finger = Sequel.cariIsi("select no_surat from surat_skbn where no_rawat = ?",TNoRw.getText());
                String no_surat = finger;
                //param.put("finger", "http://simrs.diskominfo-sultra.com/surat/SuratSKBN.php?no_surat="+getMd5(no_surat));
                param.put("finger","http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/surat/SuratSKBN.php?no_surat="+getMd5(no_surat));
                param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
                Valid.MyReportqry("rptBebasNarkoba.jasper","report","::[ Surat SKBN ]::",
                              " select reg_periksa.no_rawat,dokter.nm_dokter,pasien.tmp_lahir,pasien.tgl_lahir,pasien.nm_pasien,pasien.tmp_lahir,pasien.pekerjaan,"+
    ...
    private void KdDok1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_KdDok1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_KdDok1ActionPerformed

    private void TDokter1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TDokter1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_TDokter1ActionPerformed

    private void TDokter1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TDokter1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_TDokter1KeyPressed
    ...
    private void TDokter2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TDokter2KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_TDokter2KeyPressed
    ...
    */
        ...
        try{
            ...
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                     // new code is here
                     "select surat_skbn.no_surat,surat_skbn.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien, "+
                     "surat_skbn.tanggalsurat,surat_skbn.kategori,surat_skbn.kd_dokter,dokter.nm_dokter,surat_skbn.petugas,surat_skbn.keperluan, "+
                     "surat_skbn.opiat,surat_skbn.ganja,surat_skbn.amphetamin,surat_skbn.methamphetamin,surat_skbn.benzodiazepin,surat_skbn.cocain "+                   
                     "from surat_skbn inner join reg_periksa on surat_skbn.no_rawat=reg_periksa.no_rawat "+
                     "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                     "inner join dokter on surat_skbn.kd_dokter=dokter.kd_dokter "+
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            TDokter2.setText(tbObat.getValueAt(tbObat.getSelectedRow(),8).toString());
            Keperluan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),9).toString());
