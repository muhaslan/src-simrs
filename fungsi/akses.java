...
public final class akses {
    ...
    private static String kode="",kode2="",nama="",kdbangsal="",alamatip="",namars="",alamatrs="",kabupatenrs="",propinsirs="",kontakrs="",emailrs="",form="",namauser=""; 
...
//                ps3=koneksi.prepareStatement("select * from petugas where nip='"+user+"'");
//                System.out.println(ps3);
                try {
                    ...
                    while(rs2.next()){
                       nama=Sequel.cariIsi("select petugas.nama from petugas where nip='"+user+"'");
                    }
                    if(nama.equals("")){
                        nama=Sequel.cariIsi("select dokter.nm_dokter from dokter where dokter.kd_dokter='"+user+"'");
                    }
                    rs2.last();
...
//                        System.out.println(kode);
                        ...
                        akses.ba_pemusnahan_obat=true;
                        akses.riwayat_pemberian_obat=true;
                        ...
                        akses.ba_pemusnahan_obat=rs2.getBoolean("ba_pemusnahan_obat");
                        akses.riwayat_pemberian_obat=rs2.getBoolean("riwayat_pemberian_obat");
                        ...
                        akses.ba_pemusnahan_obat=false;
                        akses.riwayat_pemberian_obat=false;
    ...
    public static String getkode(){return akses.nama;}
    public static String getkode2(){return akses.kode2;}
    public static String getkode3(){return akses.kode;}
    ...
    public static boolean getba_pemusnahan_obat(){return akses.ba_pemusnahan_obat;}
    public static boolean getriwayat_pemberian_obat(){return akses.riwayat_pemberian_obat;}
