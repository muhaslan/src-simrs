...
public class DlgUser extends javax.swing.JDialog {
    ...
    public DlgUser(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"ID User","Nama User","Jabatan","Password","[J]ICD 10","[J]Obat Penyakit","[C]Dokter","[A]Jadwal Praktek","[C]Petugas","[M]Pasien","[A]Registrasi","[A]Tindakan Ralan",
                ...
                "[F]Riwayat Barang Dapur","[F]Permintaan Barang Dapur","[M]Rekonsiliasi Obat","[F]Biaya Pengadaan Dapur","[F]Rekap Pengadaan Dapur","[D]Berita Acara Pemusnahan Obat","[D}Riwayat Pemberian Obat","[C]Indikator Mutu","[K]Tarif MCU",
                "[A]Lihat Hasil Lab","[A]Lihat Hasil Rad","[A]IGD Ponek","[A]Skrining Awal Pasien", "[A]Partus","[A]Non Partus","[A]Observasi Persalinan","[A]Identitas Bayi"
        };
        ...
        dlgdokter.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(dlgdokter.getTable().getSelectedRow()!= -1){
                    ...
                    TNmUser.setText(dlgdokter.getTable().getValueAt(dlgdokter.getTable().getSelectedRow(),2).toString());
        ...
        dlgpetugas.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(dlgpetugas.getTable().getSelectedRow()!= -1){                   
                    ...
                    TNmUser.setText(dlgpetugas.getTable().getValueAt(dlgpetugas.getTable().getSelectedRow(),2).toString());
        ...
        if(TKd.getText().trim().equals("")||TNmUser.getText().trim().equals("")){
            ...
            if(i!= -1){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+tbUser.getValueAt(i,0).toString()+"','nur')",
                    ...
                    "ba_pemusnahan_obat='"+tbUser.getValueAt(i,922).toString()+"',"+
                    "riwayat_pemberian_obat='"+tbUser.getValueAt(i,923).toString()+"',"+
                    "indikator_mutu='"+tbUser.getValueAt(i,924).toString()+"',"+
                    "tarif_mcu='"+tbUser.getValueAt(i,925).toString()+"',"+
                    "seek_lab='"+tbUser.getValueAt(i,926).toString()+"',"+
                    "seek_rad='"+tbUser.getValueAt(i,927).toString()+"',"+
                    "igd_ponek='"+tbUser.getValueAt(i,928).toString()+"',"+
                    "skrining_pasien='"+tbUser.getValueAt(i,929).toString()+"',"+
                    "partus='"+tbUser.getValueAt(i,930).toString()+"',"+
                    "non_partus='"+tbUser.getValueAt(i,931).toString()+"',"+
                    "observasi_persalinan='"+tbUser.getValueAt(i,932).toString()+"',"+
                    "identitas_bayi='"+tbUser.getValueAt(i,923).toString()+"'"
                );
            }            
            tampil();
            emptTeks();
                            ...
                            try {
                                ...
                                if(i!= -1){
                                    Sequel.mengedit("user","id_user=AES_ENCRYPT('"+tbUser.getValueAt(i,0).toString()+"','nur')",
                                        ...
                                        "ba_pemusnahan_obat='"+tbUser.getValueAt(barisdicopy,922).toString()+"',"+
                                        "riwayat_pemberian_obat='"+tbUser.getValueAt(barisdicopy,923).toString()+"',"+
                                        "indikator_mutu='"+tbUser.getValueAt(barisdicopy,924).toString()+"',"+
                                        "tarif_mcu='"+tbUser.getValueAt(barisdicopy,925).toString()+"',"+
                                        "seek_lab='"+tbUser.getValueAt(barisdicopy,926).toString()+"',"+
                                        "seek_rad='"+tbUser.getValueAt(barisdicopy,927).toString()+"',"+
                                        "igd_ponek='"+tbUser.getValueAt(barisdicopy,928).toString()+"',"+
                                        "skrining_pasien='"+tbUser.getValueAt(barisdicopy,929).toString()+"',"+
                                        "partus='"+tbUser.getValueAt(barisdicopy,930).toString()+"',"+
                                        "non_partus='"+tbUser.getValueAt(barisdicopy,931).toString()+"',"+
                                        "observasi_persalinan='"+tbUser.getValueAt(barisdicopy,932).toString()+"',"+
                                        "identitas_bayi='"+tbUser.getValueAt(barisdicopy,933).toString()+"'"
                                    );
                                }    
                                userdicopy="";
                                copyhakakses="";
                    ...
                    try {
                        if(rs.getString(1).toLowerCase().contains(TCari.getText().toLowerCase())||
                            ...
                            tabMode.addRow(new Object[]{rs.getString(1),
                               ...
                               rs.getBoolean("ba_pemusnahan_obat"),
                               rs.getBoolean("riwayat_pemberian_obat"),
                               rs.getBoolean("indikator_mutu"),
                               rs.getBoolean("tarif_mcu"),
                               rs.getBoolean("seek_lab"),
                               rs.getBoolean("seek_rad"),
                               rs.getBoolean("igd_ponek"),
                               rs.getBoolean("skrining_pasien"),
                               rs.getBoolean("partus"),
                               rs.getBoolean("non_partus"),
                               rs.getBoolean("observasi_persalinan"),
                               rs.getBoolean("identitas_bayi")
                            });
                        }   
                    } catch (Exception e) {
                        tabMode.addRow(new Object[]{rs.getString(1),
