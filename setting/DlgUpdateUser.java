    ...
    private void tampil(String user) {  
        ...
        try{    
            ...
            ps=koneksi.prepareStatement(
                ...
                "user.biaya_pengadaan_dapur,user.rekap_pengadaan_dapur,user.ba_pemusnahan_obat,user.riwayat_pemberian_obat,user.indikator_mutu,user.tarif_mcu from user where user.id_user=AES_ENCRYPT(?,'nur')");
            try {
                ps.setString(1,user);
                rs=ps.executeQuery();
                if(rs.next()){
                    ...
                    biaya_pengadaan_dapur=rs.getBoolean("biaya_pengadaan_dapur");rekap_pengadaan_dapur=rs.getBoolean("rekap_pengadaan_dapur");ba_pemusnahan_obat=rs.getBoolean("ba_pemusnahan_obat");riwayat_pemberian_obat=rs.getBoolean("riwayat_pemberian_obat");indikator_mutu=rs.getBoolean("indikator_mutu");tarif_mcu=rs.getBoolean("tarif_mcu");
                    setTampil();
                }       
