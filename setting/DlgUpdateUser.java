...
public class DlgUpdateUser extends javax.swing.JDialog {
    ...
    */
    ...
    private void tampil(String user) {  
        ...
        try{    
            ...
            ps=koneksi.prepareStatement(
                ...
                "user.biaya_pengadaan_dapur,user.rekap_pengadaan_dapur,user.ba_pemusnahan_obat,user.riwayat_pemberian_obat,user.indikator_mutu,user.tarif_mcu,user.seek_lab,user.seek_rad from user where user.id_user=AES_ENCRYPT(?,'nur')");
            try {
                ps.setString(1,user);
                rs=ps.executeQuery();
                if(rs.next()){
    ...
    private void setTampil(){
        ...
        if("[A]Lihat Hasil Laboratorium".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Lihat Hasil Laboratorium",seek_lab});
        }
        
        if("[A]Lihat Hasil Radiologi".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Lihat Hasil Radiologi",seek_rad});
        }
        ...
        if("[D]Ba Pemusnahan Obat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Ba Pemusnahan Obat",ba_pemusnahan_obat});
        }
        
        if("[D]Riwayat Pemberian Obat".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[D]Riwayat Pemberian Obat",riwayat_pemberian_obat});
        }
        
        if("[C]Indikator Mutu".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Indikator Mutu",indikator_mutu});
        }
        ...
        if("[K]Tarif MCU".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[C]Tarif MCU",tarif_mcu});
        }
        ...
        if("[O]Limbah B3 Medis Per Tanggal".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Limbah B3 Medis Per Tanggal",grafik_limbahb3_pertanggal});
        }

        if("[O]Limbah B3 Medis Per Bulan".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[O]Limbah B3 Medis Per Bulan",grafik_limbahb3_perbulan});
        }
    ...
    private void Simpan() {
        for(i=0;i<tbUser.getRowCount();i++){ 
            ...
            if("[A]Lihat Hasil Laboratorium".equals(tbUser.getValueAt(i,1).toString())){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+TKd.getText()+"','nur')","seek_lab='"+tbUser.getValueAt(i,2).toString()+"'");
            }
            
            if("[A]Lihat Hasil Radiologi".equals(tbUser.getValueAt(i,1).toString())){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+TKd.getText()+"','nur')","seek_rad='"+tbUser.getValueAt(i,2).toString()+"'");
            }
            ...
            if("[D]Ba Pemusnahan Obat".equals(tbUser.getValueAt(i,1).toString())){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+TKd.getText()+"','nur')","ba_pemusnahan_obat='"+tbUser.getValueAt(i,2).toString()+"'");
            }
            
            if("[D]Riwayat Pemberian Obat".equals(tbUser.getValueAt(i,1).toString())){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+TKd.getText()+"','nur')","riwayat_pemberian_obat='"+tbUser.getValueAt(i,2).toString()+"'");
            }
            
            if("[C]Indikator Mutu".equals(tbUser.getValueAt(i,1).toString())){
            ...
            if("[K]Tarif MCU".equals(tbUser.getValueAt(i,1).toString())){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+TKd.getText()+"','bur')","tarif_mcu='"+tbUser.getValueAt(i,2).toString()+"'");
            }
        }
    }
    ...
    private void Simpan2() {
        for(i=0;i<tbUser.getRowCount();i++){ 
            ...
            if("[O]Limbah B3 Medis Per Tanggal".equals(tbUser.getValueAt(i,1).toString())){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+TKd.getText()+"','nur')","grafik_limbahb3_pertanggal='"+tbUser.getValueAt(i,2).toString()+"'");
            }

            if("[O]Limbah B3 Medis Per Bulan".equals(tbUser.getValueAt(i,1).toString())){
