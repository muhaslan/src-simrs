...
public class DlgUpdateUser extends javax.swing.JDialog {
    ...
    */
    ...
    private void setTampil(){
        ...
        if("[A]IGD Ponek".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]IGD Ponek",igd_ponek});
        }
    ...
    private void Simpan() {
        for(i=0;i<tbUser.getRowCount();i++){ 
            ...
            if("[A]IGD Ponek".equals(tbUser.getValueAt(i,1).toString())){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+TKd.getText()+"','nur')","igd_ponek='"+tbUser.getValueAt(i,2).toString()+"'");
            }
