...
public final class DlgCariPetugas extends javax.swing.JDialog {
    ...
    public DlgCariPetugas(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"Username","NIP/NPRS","Nama Petugas","J.K.","Tmp.Lahir","Tgl.Lahir","G.D.","Agama","Stts.Nikah","Alamat","Jabatan","No.Telp"};
    ...
    */
    ...
    private void tampil() {  
        ...
        try{
            ...
            iyem="";
            ps=koneksi.prepareStatement("select nip,username,nama,jk,tmp_lahir,tgl_lahir, "+
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    iyem=iyem+"{\"NIP\":\""+rs.getString(1)+"\",\"Username\":\""+rs.getString(2)+"\",\"NamaPetugas\":\""+rs.getString(3).replaceAll("\"","")+"\",\"JK\":\""+rs.getString(4)+"\",\"TmpLahir\":\""+rs.getString(5).replaceAll("\"","")+"\",\"TglLahir\":\""+rs.getString(6)+"\",\"GD\":\""+rs.getString(7)+"\",\"Agama\":\""+rs.getString(8)+"\",\"SttsNikah\":\""+rs.getString(9)+"\",\"Alamat\":\""+rs.getString(10).replaceAll("\"","")+"\",\"Jabatan\":\""+rs.getString(11)+"\",\"NoTelp\":\""+rs.getString(12)+"\"},";
                }
            } catch (Exception e) {
            ...
            if(response.isArray()){
                for(JsonNode list:response){
                    if(list.path("NIP").asText().toLowerCase().contains(TCari.getText().toLowerCase())||list.path("NamaPetugas").asText().toLowerCase().contains(TCari.getText().toLowerCase())||list.path("Jabatan").asText().toLowerCase().contains(TCari.getText().toLowerCase())){
                        tabMode.addRow(new Object[]{
                            list.path("NIP").asText(),list.path("Username").asText(),list.path("NamaPetugas").asText(),list.path("JK").asText(),list.path("TmpLahir").asText(),list.path("TglLahir").asText(),list.path("GD").asText(),list.path("Agama").asText(),list.path("SttsNikah").asText(),list.path("Alamat").asText(),list.path("Jabatan").asText(),list.path("NoTelp").asText()
                        });
                    }
                }
            }
