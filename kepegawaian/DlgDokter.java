...
public class DlgDokter extends javax.swing.JDialog {
    ...
    public DlgDokter(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"Username","NIP/NPRS","Nama Dokter","J.K.","Tmp.Lahir","Tgl.Lahir","G.D.","Agama","Alamat Tinggal","No.HP/Telp","Stts.Nikah","Spesialis","Alumni","No.Ijin Praktek"};
    ...
    private void initComponents() {
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(32768, 200));
        ...
        FormInput.add(CmbJk);
        CmbJk.setBounds(110, 100, 110, 23);
        ...
        jLabel9.setBounds(220, 100, 75, 23);
        ...
        FormInput.add(CMbGd);
        CMbGd.setBounds(300, 100, 65, 23);

        jLabel13.setText("Tmp/Tgl. Lahir :");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(376, 70, 105, 23);
        ...
        DTPLahir.setBounds(640, 72, 104, 23);
        ...
        jLabel21.setBounds(840, 10, 90, 23);
        ...
        if(TKd.getText().trim().equals("")){
            ...
            try { 
                ...
                Sequel.menyimpanignore("pegawai","'0','"+TKd.getText()+"','"+TNm.getText()+"','"+CmbJk.getSelectedItem().toString().replaceAll("PEREMPUAN","Wanita").replaceAll("LAKI-LAKI","Pria")+"',"+
                        "'-','-','-','-','-','-','-','-','-','-','-','0','"+TTmp.getText()+"','"+Valid.SetTgl(DTPLahir.getSelectedItem()+"")+"','"+TAlmt.getText()+"','-','1900-01-01','<1','-','T','-','AKTIF','0','0','0','1900-01-01','0','0','pages/pegawai/photo/','-','0000-00-00','0000-00-00','0000-00-00','0000-00-00','Purna','-','-'"
                );        
...
//                         TAlumni.getText()+"','"+
//                         nprs.getText()+"','"+
//                         TNoi.getText()+"',1","NIP/NPRS");
                Sequel.menyimpan("dokter","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","NIP",15,new String[]{
                        ...
                        cmbAgama.getSelectedItem().toString(),TAlmt.getText(),TTlp.getText(),CmbStts.getSelectedItem().toString(),
                        KdSps.getText(),TAlumni.getText(),TNoi.getText(),"1",nprs.getText()
                 });
                Sequel.Commit();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            try { 
                ...
                Sequel.mengedit("dokter","kd_dokter='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString()+"'",
                        "kd_dokter='"+TKd.getText()+
                        "',nm_dokter='"+TNm.getText()+
    ...
    private void tampil() {
        ...
        try {
            stat=koneksi.prepareStatement(
                   "select dokter.kd_dokter,dokter.username,dokter.nm_dokter,dokter.jk,dokter.tmp_lahir, "+
                   "dokter.tgl_lahir,dokter.gol_drh,dokter.agama,dokter.almt_tgl,dokter.no_telp, "+
                   "dokter.stts_nikah,spesialis.nm_sps,dokter.alumni,dokter.no_ijn_praktek "+
                   "from dokter inner join spesialis on dokter.kd_sps=spesialis.kd_sps "+
                   ...
                   "dokter.status='1' and dokter.jk like ? and dokter.gol_drh like ? and dokter.stts_nikah like ? and dokter.username like ? "+
...
//                Status STR
//                String awalStr = rs.getString(14);
//                String akhirStr = rs.getString(15);
...
//                status SIP
//                String awalSip = rs.getString(16);
//                String akhirSip = rs.getString(17);
...
//        Valid.autoNomer(" dokter ","D",7,TKd);
    ...
    private void getData() {
        ...
        if(row!= -1){
            ...
            nprs.setText(tbDokter.getValueAt(row,1).toString());
            TNm.setText(tbDokter.getValueAt(row,2).toString());
            TTmp.setText(tbDokter.getValueAt(row,4).toString());
            CMbGd.setSelectedItem(tbDokter.getValueAt(row,6).toString());
            cmbAgama.setSelectedItem(tbDokter.getValueAt(row,7).toString());
            TAlmt.setText(tbDokter.getValueAt(row,8).toString());
            TTlp.setText(tbDokter.getValueAt(row,9).toString());
            CmbStts.setSelectedItem(tbDokter.getValueAt(row,10).toString());
            TSpesialis.setText(tbDokter.getValueAt(row,11).toString());
            Sequel.cariIsi("select kd_sps from spesialis where nm_sps='"+tbDokter.getValueAt(row,11).toString()+"'", KdSps);
            TAlumni.setText(tbDokter.getValueAt(row,12).toString());
            TNoi.setText(tbDokter.getValueAt(row,13).toString());
            
            switch (tbDokter.getValueAt(row,3).toString()) {
                case "L":
            ...
            Valid.SetTgl(DTPLahir,tbDokter.getValueAt(row,5).toString());
        }
    }
