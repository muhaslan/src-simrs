...
public final class DlgPetugas extends javax.swing.JDialog {
    ...
    public DlgPetugas(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"Username","NIP/NPRS","Nama Petugas","J.K.","Tmp.Lahir","Tgl.Lahir","G.D.","Agama","Stts.Nikah","Alamat","Stts. Tenaga Medis","No.Telp"};
        ...
        pegawai.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(pegawai.getTable().getSelectedRow()!= -1){                   
                    nprs.setText(pegawai.tbKamar.getValueAt(pegawai.tbKamar.getSelectedRow(),0).toString());
    ...
    private void initComponents() {
        ...
        Scroll.setPreferredSize(new java.awt.Dimension(452, 420));
        ...
        FormInput.setMaximumSize(new java.awt.Dimension(500, 500));
        FormInput.setMinimumSize(new java.awt.Dimension(0, 0));
        FormInput.setName("FormInput"); // NOI18N
        FormInput.setOpaque(false);
        FormInput.setPreferredSize(new java.awt.Dimension(501, 200));
        ...
        FormInput.add(CmbJk);
        CmbJk.setBounds(110, 100, 140, 23);
        ...
        FormInput.add(CMbGd);
        CMbGd.setBounds(350, 100, 70, 23);

        jLabel13.setText("Tmp/Tgl. Lahir :");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(460, 72, 105, 23);
        ...
        DTPLahir.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                DTPLahirActionPerformed(evt);
            }
        });
        ...
        DTPLahir.setBounds(780, 72, 100, 23);
        ...
        CmbStts.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "MENIKAH", "BELUM MENIKAH" }));
        CmbStts.setLightWeightPopupEnabled(false);
        CmbStts.setName("CmbStts"); // NOI18N
        CmbStts.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                CmbSttsActionPerformed(evt);
            }
        });
        ...
        jLabel21.setBounds(860, 10, 80, 23);

        jLabel12.setText("Jns. Tenaga Medis :");
        jLabel12.setName("jLabel12"); // NOI18N
        FormInput.add(jLabel12);
        jLabel12.setBounds(435, 102, 130, 23);

        TJbtn.setEditable(false);
        TJbtn.setName("TJbtn"); // NOI18N
        TJbtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TJbtnActionPerformed(evt);
            }
        });
        FormInput.add(TJbtn);
        TJbtn.setBounds(655, 102, 242, 23);
        ...
        KdJbtn.setBounds(567, 102, 86, 23);
        ...
        btnJabatan.setBounds(900, 102, 28, 23);
        ...
        jLabel5.setText("NIP/NPRS :");
        jLabel5.setName("jLabel5"); // NOI18N
        FormInput.add(jLabel5);
        jLabel5.setBounds(0, 40, 105, 23);

        nprs.setHighlighter(null);
        nprs.setName("nprs"); // NOI18N
        nprs.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                nprsKeyPressed(evt);
            }
        });
        FormInput.add(nprs);
        nprs.setBounds(110, 40, 200, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        }else if(nprs.getText().trim().equals("")){
            Valid.textKosong(nprs,"Username");
        }else{
            try {
                ...
                Sequel.menyimpanignore("pegawai","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",41,new String[]{
                    ...
                    "-","T","-","AKTIF","0","0","0","1900-01-01","0","0","-","-","-","-","0000-00-00","0000-00-00","0000-00-00","0000-00-00","Purna"
                });
                ...
                Sequel.menyimpan("petugas","?,?,?,?,?,?,?,?,?,?,?,?,?","NIP",13,new String[]{
                    ...
                    TAlmt.getText(),KdJbtn.getText(),TTlp.getText(),"1",nprs.getText()
                });
                Sequel.Commit();
        ...
        if(TNip.getText().trim().equals("")){
            ...
            try {
                ...
                Sequel.mengedit("petugas","nip='"+tbPetugas.getValueAt(tbPetugas.getSelectedRow(),0).toString()+"'",
                        ...
                        "',username='"+nprs.getText()+
                        "',kd_jbtn='"+KdJbtn.getText()+"'");
//                Sequel.mengedit("petugas","nip='"+tbPetugas.getValueAt(tbPetugas.getSelectedRow(),0).toString()+"'",
//                        "nip='"+TNip.getText()+"',nama='"+TNm.getText()+"',jk='"+CmbJk.getSelectedItem().toString().replaceAll("PEREMPUAN","Wanita").replaceAll("LAKI-LAKI","Pria")+"',"+
//                        "tmp_lahir='"+TTmp.getText()+"',tgl_lahir='"+Valid.SetTgl(DTPLahir.getSelectedItem()+"")+"',alamat='"+TAlmt.getText()+"',"+
//                        "no_telp='"+TTlp.getText()+"',gol_darah='"+CMbGd.getSelectedItem()+"',stts_nikah='"+CmbStts.getSelectedItem()+"',"+
//                        "agama='"+cmbAgama.getSelectedItem()+
//                        "',kd_jbtn='"+KdJbtn.getText()+"',"+
//                        "awal_sip='"+Valid.SetTgl(DTPLahir1.getSelectedItem()+"")+"',akhir_sip='"+Valid.SetTgl(DTPLahir2.getSelectedItem()+"")+"',"+
//                        "awal_str='"+Valid.SetTgl(DTPLahir3.getSelectedItem()+"")+"',akhir_str='"+Valid.SetTgl(DTPLahir4.getSelectedItem()+"")+"',"+
//                        "stts_kepegawaian='"+CmbStts1.getSelectedItem()+"' where nip='"+tbPetugas.getValueAt(tbPetugas.getSelectedRow(),0).toString()+"'");
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
  isForm();                
    ...
    private void CmbSttsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CmbSttsActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_CmbSttsActionPerformed

    private void DTPLahirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DTPLahirActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_DTPLahirActionPerformed

    private void TJbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TJbtnActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_TJbtnActionPerformed

    private void nprsKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_nprsKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_nprsKeyPressed
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    "select petugas.nip,petugas.username,petugas.nama,petugas.jk,petugas.tmp_lahir,petugas.tgl_lahir, "+
                    "petugas.gol_darah,petugas.agama,petugas.stts_nikah,petugas.alamat,jabatan.nm_jbtn,petugas.no_telp "+
                    "from petugas inner join jabatan on jabatan.kd_jbtn=petugas.kd_jbtn "+
                    "where petugas.status='1' and petugas.jk like ? and petugas.gol_darah like ? and petugas.stts_nikah like ? and "+
                    "(petugas.nip like ? or petugas.username like ? or petugas.nama like ? or petugas.tmp_lahir like ? or petugas.tgl_lahir like ? or "+
...
//                Status STR
//                String awalStr = rs.getString(12);
//                String akhirStr = rs.getString(13);
//                SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
//                Date awal = format.parse(awalStr);
//                Date akhir = format.parse(akhirStr);
//                Date sekarang = new Date();
//                long selisih = akhir.getTime() - sekarang.getTime();
//                long hari = selisih / (1000 * 60 * 60 * 24);
//                String msg = "";
//                if (hari <= 90 && hari >= 60){
//                    msg = " (3 Bulan Lagi Expire)";
//                    String msg2 = "STR " + rs.getString(2) + " 3 Bulan Lagi Expire";
//                    JOptionPane.showMessageDialog(null, msg2);
//                } else if (hari <= 60 && hari >= 30){
//                    msg = " (2 Bulan Lagi Expire)";
//                    String msg2 = "STR " + rs.getString(2) + " 2 Bulan Lagi Expire";
//                    JOptionPane.showMessageDialog(null, msg2);
//                } else if (hari <= 30 && hari > 1){
//                    msg = " (1 Bulan Lagi Expire)";
//                    String msg2 = "STR " + rs.getString(2) + " 1 Bulan Lagi Expire";
//                    JOptionPane.showMessageDialog(null, msg2);
//                } else if (hari <= 1){
//                    msg = " (Expire)";
//                    String msg2 = "STR " + rs.getString(2) + " Expire";
//                    JOptionPane.showMessageDialog(null, msg2);
//                } else {
//                    msg = " (Aktif)";
//                }
...
//                status SIP
//                String awalSip = rs.getString(14);
//                String akhirSip = rs.getString(15);
//                SimpleDateFormat formatSip = new SimpleDateFormat("yyyy-MM-dd");
//                Date awal1 = formatSip.parse(awalSip);
//                Date akhir1 = formatSip.parse(akhirSip);
//                long selisih1 = akhir1.getTime() - sekarang.getTime();
//                long hari1 = selisih1 / (1000 * 60 * 60 * 24);
//                String msg1 = "";
//                if (hari1 <= 90 && hari1 >= 60){
//                    msg1 = " (3 Bulan Lagi Expire)";
//                    String msg2 = "SIP " + rs.getString(2) + " 3 Bulan Lagi Expire";
//                    JOptionPane.showMessageDialog(null, msg2);
//                } else if (hari1 <= 60 && hari1 >= 30){
//                    msg1 = " (2 Bulan Lagi Expire)";
//                    String msg2 = "SIP " + rs.getString(2) + " 2 Bulan Lagi Expire";
//                    JOptionPane.showMessageDialog(null, msg2);
//                } else if (hari1 <= 30 && hari1 > 1){
//                    msg1 = " (1 Bulan Lagi Expire)";
//                    String msg2 = "SIP " + rs.getString(2) + " 1 Bulan Lagi Expire";
//                    JOptionPane.showMessageDialog(null, msg2);
//                } else if (hari1 <= 1){
//                    msg1 = " (Expire)";
//                    String msg2 = "SIP " + rs.getString(2) + " Expire";
//                    JOptionPane.showMessageDialog(null, msg2);
//                } else {
//                    msg1 = " (Aktif)";
//                }
...
//                    msg,msg,msg1,msg1,rs.getString(16)
                });
//                    System.out.println(rs.getString(12)+ " " +rs.getString(13));
                }
            } catch (Exception e) {
    ...
    private void getData() {
        ...
        if(row!= -1){
            ...
            nprs.setText(tbPetugas.getValueAt(row,1).toString());
            TNm.setText(tbPetugas.getValueAt(row,2).toString());

            switch (tbPetugas.getValueAt(row,3).toString()) {
                case "L":
            ...
            TTmp.setText(tbPetugas.getValueAt(row,4).toString());
            
            CMbGd.setSelectedItem(tbPetugas.getValueAt(row,6).toString());
            cmbAgama.setSelectedItem(tbPetugas.getValueAt(row,7).toString());
            CmbStts.setSelectedItem(tbPetugas.getValueAt(row,8).toString());
            TAlmt.setText(tbPetugas.getValueAt(row,9).toString());
            Sequel.cariIsi("select jabatan.kd_jbtn from jabatan where jabatan.nm_jbtn='"+tbPetugas.getValueAt(row,9).toString()+"'", KdJbtn);
            TJbtn.setText(tbPetugas.getValueAt(row,10).toString());
            TTlp.setText(tbPetugas.getValueAt(row,11).toString());
            Valid.SetTgl(DTPLahir,tbPetugas.getValueAt(row,5).toString());
        }
    }
