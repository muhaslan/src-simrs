 ...
 * @author perpustakaan
 */
public class DlgIndikatorMutu extends javax.swing.JDialog {
    ...
    public DlgIndikatorMutu(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        initComponents2();
        try {
                        ...
                        if(engine.getLocation().contains("/webapps/penggajian/index.php?act=HomeAdmin")){
                            try{            
                                if(prop.getProperty("MENUTRANSPARAN").equals("yes")){
                                    DlgIndikatorMutu.this.setOpacity(0.77f);
                                }               
                            }catch(Exception e){
                            }
                        }else{
                            try{     
                                if(prop.getProperty("MENUTRANSPARAN").equals("yes")){
                                    DlgIndikatorMutu.this.setOpacity(1f);
                                }                                                                      
                            }catch(Exception e){
                            }
                        }
                        DlgIndikatorMutu.this.setTitle(newValue);
                    });
                });
                ...
                engine.getLoadWorker().stateProperty().addListener(new ChangeListener<State>() {
                    ...
                    public void changed(ObservableValue ov, State oldState, State newState) {
                        if (newState == State.SUCCEEDED) {
                            try {
                                if(engine.getLocation().replaceAll("http://"+koneksiDB.HOSTHYBRIDWEB()+":"+prop.getProperty("PORTWEB")+"/"+prop.getProperty("HYBRIDWEB")+"/","").contains("indikatorutama/pages")){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Indikator Mutu ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgIndikatorMutu dialog = new DlgIndikatorMutu(new javax.swing.JFrame(), true);
