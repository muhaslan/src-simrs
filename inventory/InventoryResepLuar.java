...
public final class InventoryResepLuar extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TabRawat.setMaximumSize(new java.awt.Dimension(400, 400));
        TabRawat.setName("TabRawat"); // NOI18N
        TabRawat.setPreferredSize(new java.awt.Dimension(399, 399));
        ...
        Scroll.setMaximumSize(new java.awt.Dimension(400, 400));
        Scroll.setName("Scroll"); // NOI18N
        Scroll.setOpaque(true);
        Scroll.setPreferredSize(new java.awt.Dimension(399, 399));
