            ...
            public void windowClosed(WindowEvent e) {
                if(akses.getform().equals("DlgPeriksaRadiologi")){
                    if(petugas.getTable().getSelectedRow()!= -1){                   
                        ...
                        NmPtg.setText(petugas.getTable().getValueAt(petugas.getTable().getSelectedRow(),2).toString());
                    } 
                    KdPtg.requestFocus();
                }
            }
        ...
        if (reply == JOptionPane.YES_OPTION) {
            ...
            if(sukses==true){
                ...
                if(status.equals("Ranap")){
                    ...
                    sukses=jur.simpanJurnal(TNoRw.getText(),"U","PEMERIKSAAN RADIOLOGI RAWAT INAP PASIEN "+TPasien.getText()+" DIPOSTING OLEH "+akses.getkode2());                                              
                }else if(status.equals("Ralan")){
                    Sequel.queryu("delete from tampjurnal");    
                    if(ttlpendapatan>0){
                    ...
                    sukses=jur.simpanJurnal(TNoRw.getText(),"U","PEMERIKSAAN RADIOLOGI RAWAT JALAN PASIEN "+TPasien.getText()+" DIPOSTING OLEH "+akses.getkode2());                                              
                }
            }
