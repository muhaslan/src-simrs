...
public final class DlgCariJabatan extends javax.swing.JDialog {
    ...
    public DlgCariJabatan(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"Kode Stts. Tng. Medis / Jabatan",
                      "Nama Stts. Tng. Medis / Jabatan"};
    ...
    private void initComponents() {
        ...
        internalFrame1.getAccessibleContext().setAccessibleName("::[ Stts. Tenaga Medis / Jabatan ]::");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        try {
            if(Valid.daysOld("./cache/jabatan.iyem")<8){
                tampil2();
            }else{
                tampil();
            }
