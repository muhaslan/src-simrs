            ...
            if(Sequel.cariRegistrasi(TNoRw.getText())>0){
                ...
                if(sukses==true){
                    if(status.equals("Ranap")){
                        ...
                        sukses=jur.simpanJurnal(TNoRw.getText(),"U","OPERASI RAWAT INAP PASIEN "+TPasien.getText()+" DIPOSTING OLEH "+akses.getkode2());                                              
                        ...
                        sukses=jur.simpanJurnal(TNoRw.getText(),"U","OPERASI RAWAT JALAN PASIEN "+TPasien.getText()+" DIPOSTING OLEH "+akses.getkode2());                                              
                    }
                }
