                ...
                try {                
                    ...
                    if(sukses==true){
                        if(status.equals("Ranap")){
                            ...
                            sukses=jur.simpanJurnal(TNoRw.getText(),"U","PEMBATALAN PEMERIKSAAN LABORAT RAWAT INAP PASIEN OLEH "+akses.getkode2());  
                            ...
                            sukses=jur.simpanJurnal(TNoRw.getText(),"U","PEMBATALAN PEMERIKSAAN LABORAT RAWAT JALAN PASIEN OLEH "+akses.getkode2());  
                        }
                    }
                    ...
                    if(sukses==true){
                        ...
                        if(sukses==true){
                            if(status.equals("Ranap")){
                                ...
                                sukses=jur.simpanJurnal(TNoRw.getText(),"U","PEMERIKSAAN LABORAT RAWAT INAP PASIEN "+TPasien.getText()+" DIPOSTING OLEH "+akses.getkode2());  
                            }else if(status.equals("Ralan")){
                                Sequel.queryu("delete from tampjurnal");    
                                if(ttlpendapatan>0){
                                ...
                                sukses=jur.simpanJurnal(TNoRw.getText(),"U","PEMERIKSAAN LABORAT RAWAT JALAN PASIEN "+TPasien.getText()+" DIPOSTING OLEH "+akses.getkode2()); 
                            }
                        }
                    }
