 ...
 * @author perpustakaan
 */
public final class RMAsesmenAwalKebidananIGDOld extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMAsesmenAwalKebidananIGDOld(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//                        NmPetugas2.setText(petugas.getTable().getValueAt(petugas.getTable().getSelectedRow(),2).toString());  
    ...
    private void initComponents() {
        ...
        HubuganDenanPasien = new widget.TextBox();
        MenggunakanLainnya1 = new widget.TextBox();
        ...
        CaraDatangLainnya3 = new widget.TextBox();
        PengkajianOleh1 = new widget.ComboBox();
        ...
        KontrasepsiLainnya = new widget.TextBox();
        ...
        TglPertamaMens = new widget.Tanggal();
        jLabel97 = new widget.Label();
        HariPerkiraanLahir = new widget.Tanggal();
        jLabel98 = new widget.Label();
        UmurKehamilan = new widget.Tanggal();
        ...
        cekBox1 = new widget.CekBox();
        cekBox3 = new widget.CekBox();
        cekBox4 = new widget.CekBox();
        ...
        TanggalPersalinan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-08-2023" }));
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-08-2023 15:54:54" }));
        ...
        jSeparator1.setBounds(0, 475, 880, 1);
        ...
        CaraMasuk.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Rumah", "Puskesmas", "Rumah Sakit" }));
        ...
        Scroll6.setBounds(60, 510, 744, 93);
        ...
        BtnTambahMasalah.setBounds(30, 510, 28, 23);
        ...
        BtnHapusRiwayatPersalinan.setBounds(30, 540, 28, 23);
        ...
        jLabel129.setBounds(10, 610, 180, 23);
        ...
        jLabel131.setBounds(10, 780, 180, 23);
        ...
        jSeparator4.setBounds(0, 780, 880, 1);
        ...
        FormInput.add(FrekAukultasi);
        FrekAukultasi.setBounds(280, 1180, 110, 23);

        LetakPunggungJanin.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Punggung kiri", "Punggun kanan", "Kepala", "Bokong" }));
        ...
        FormInput.add(LetakPunggungJanin);
        LetakPunggungJanin.setBounds(170, 1060, 110, 23);
        ...
        FormInput.add(PresentasiJanin);
        PresentasiJanin.setBounds(170, 1090, 110, 23);
        ...
        jLabel167.setBounds(10, 1570, 380, 23);
        ...
        PanelWall.setBounds(30, 1600, 460, 190);
        ...
        jSeparator10.setBounds(0, 1570, 880, 1);
        ...
        jSeparator12.setBounds(0, 1990, 880, 1);
        ...
        MenggunakanLainnya.setBounds(847, 70, 80, 23);

        HubuganDenanPasien.setHighlighter(null);
        HubuganDenanPasien.setName("HubuganDenanPasien"); // NOI18N
        FormInput.add(HubuganDenanPasien);
        HubuganDenanPasien.setBounds(447, 100, 80, 23);

        MenggunakanLainnya1.setHighlighter(null);
        MenggunakanLainnya1.setName("MenggunakanLainnya1"); // NOI18N
        FormInput.add(MenggunakanLainnya1);
        MenggunakanLainnya1.setBounds(610, 70, 80, 23);
        ...
        CaraDatangLainnya3.setHighlighter(null);
        CaraDatangLainnya3.setName("CaraDatangLainnya3"); // NOI18N
        CaraDatangLainnya3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                CaraDatangLainnya3ActionPerformed(evt);
            }
        });
        FormInput.add(CaraDatangLainnya3);
        CaraDatangLainnya3.setBounds(620, 100, 190, 23);

        PengkajianOleh1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Pasien Sendiri", "Keluarga" }));
        PengkajianOleh1.setName("PengkajianOleh1"); // NOI18N
        PengkajianOleh1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                PengkajianOleh1KeyPressed(evt);
            }
        });
        FormInput.add(PengkajianOleh1);
        PengkajianOleh1.setBounds(148, 100, 150, 23);
        ...
        Hypertensi.setBounds(10, 50, 90, 17);
        ...
        PenyakitGinjal.setBounds(110, 30, 110, 17);
        ...
        PenyakitJantung.setBounds(110, 10, 104, 17);
        ...
        PenyakitThyroid.setBounds(110, 50, 110, 17);
        ...
        Hepatitis.setBounds(240, 10, 65, 17);
        ...
        DiabetesMelitus.setBounds(240, 30, 110, 17);
        ...
        PenyakitKelamin.setBounds(240, 50, 140, 17);
        ...
        Epilepsi.setBounds(380, 10, 70, 17);
        ...
        Gamelli.setBounds(180, 270, 150, 23);

        jLabel75.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel75.setText("        3. Ketergantungan               : ");
        jLabel75.setName("jLabel75"); // NOI18N
        FormInput.add(jLabel75);
        jLabel75.setBounds(0, 300, 180, 23);

        Ketergantungan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak Ada", "Ada" }));
        ...
        FormInput.add(Ketergantungan);
        Ketergantungan.setBounds(180, 300, 150, 23);
        ...
        FormInput.add(InputKetergantungan);
        InputKetergantungan.setBounds(335, 300, 150, 23);

        jLabel76.setText("Sejak : ");
        jLabel76.setName("jLabel76"); // NOI18N
        FormInput.add(jLabel76);
        jLabel76.setBounds(500, 300, 40, 23);
        ...
        FormInput.add(KetergantunganSejak);
        KetergantunganSejak.setBounds(540, 300, 80, 23);

        jLabel77.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel77.setText("        4. Riwayat Alergi                  ");
        jLabel77.setName("jLabel77"); // NOI18N
        FormInput.add(jLabel77);
        jLabel77.setBounds(0, 330, 180, 23);

        jLabel78.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel78.setText("   Obat - Obatan :");
        jLabel78.setName("jLabel78"); // NOI18N
        FormInput.add(jLabel78);
        jLabel78.setBounds(30, 353, 90, 23);
        ...
        FormInput.add(ObatObatan);
        ObatObatan.setBounds(120, 353, 150, 23);

        jLabel79.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel79.setText("   Makanan         :");
        jLabel79.setName("jLabel79"); // NOI18N
        FormInput.add(jLabel79);
        jLabel79.setBounds(30, 383, 90, 23);
        ...
        Makanan.setBounds(120, 383, 150, 23);

        jLabel80.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel80.setText("   Debu              :");
        jLabel80.setName("jLabel80"); // NOI18N
        FormInput.add(jLabel80);
        jLabel80.setBounds(30, 413, 90, 23);
        ...
        FormInput.add(Debu);
        Debu.setBounds(120, 413, 150, 23);

        jLabel81.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel81.setText("   Lainnya           :");
        jLabel81.setName("jLabel81"); // NOI18N
        FormInput.add(jLabel81);
        jLabel81.setBounds(30, 443, 90, 23);
        ...
        FormInput.add(TinggiFundus);
        TinggiFundus.setBounds(170, 1030, 70, 23);

        jLabel84.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel84.setText("Hari");
        jLabel84.setName("jLabel84"); // NOI18N
        FormInput.add(jLabel84);
        jLabel84.setBounds(425, 662, 50, 23);

        jLabel85.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel85.setText("- Menstruasi                 :");
        jLabel85.setName("jLabel85"); // NOI18N
        FormInput.add(jLabel85);
        jLabel85.setBounds(30, 662, 130, 23);
        ...
        Menstruasi.setBounds(160, 662, 110, 23);
        ...
        FormInput.add(HariMens);
        HariMens.setBounds(280, 662, 140, 23);

        jLabel86.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel86.setText("Tahun");
        jLabel86.setName("jLabel86"); // NOI18N
        FormInput.add(jLabel86);
        jLabel86.setBounds(230, 635, 50, 23);

        jLabel87.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel87.setText("- Sakit Saat Menstruasi :");
        jLabel87.setName("jLabel87"); // NOI18N
        FormInput.add(jLabel87);
        jLabel87.setBounds(30, 690, 130, 23);
        ...
        FormInput.add(SakitSaatMens);
        SakitSaatMens.setBounds(160, 690, 110, 23);

        jLabel88.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel88.setText("- G");
        jLabel88.setName("jLabel88"); // NOI18N
        FormInput.add(jLabel88);
        jLabel88.setBounds(30, 810, 20, 23);
        ...
        FormInput.add(Menikahke);
        Menikahke.setBounds(160, 720, 110, 23);

        jLabel89.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel89.setText("   Lamanya pernikahan :");
        jLabel89.setName("jLabel89"); // NOI18N
        FormInput.add(jLabel89);
        jLabel89.setBounds(270, 720, 130, 23);
        ...
        FormInput.add(LamanyaMenikah);
        LamanyaMenikah.setBounds(393, 720, 110, 23);
        ...
        FormInput.add(NmKontrasepsi);
        NmKontrasepsi.setBounds(225, 750, 160, 23);

        jLabel90.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel90.setText("   - Hari pertama haid terakhir :");
        jLabel90.setName("jLabel90"); // NOI18N
        FormInput.add(jLabel90);
        jLabel90.setBounds(20, 838, 160, 23);

        jLabel92.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel92.setText("   Lamanya :");
        jLabel92.setName("jLabel92"); // NOI18N
        FormInput.add(jLabel92);
        jLabel92.setBounds(390, 750, 70, 23);

        KontrasepsiLainnya.setHighlighter(null);
        KontrasepsiLainnya.setName("KontrasepsiLainnya"); // NOI18N
        KontrasepsiLainnya.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                KontrasepsiLainnyaActionPerformed(evt);
            }
        });
        FormInput.add(KontrasepsiLainnya);
        KontrasepsiLainnya.setBounds(455, 750, 110, 23);

        jLabel91.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel91.setText("   - Menikah yang ke        :");
        jLabel91.setName("jLabel91"); // NOI18N
        FormInput.add(jLabel91);
        jLabel91.setBounds(20, 720, 140, 23);
        ...
        FormInput.add(Menarche);
        Menarche.setBounds(160, 635, 70, 23);

        jLabel93.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel93.setText("P");
        jLabel93.setName("jLabel93"); // NOI18N
        FormInput.add(jLabel93);
        jLabel93.setBounds(100, 810, 20, 23);
        ...
        FormInput.add(InputP);
        InputP.setBounds(110, 810, 40, 23);
        ...
        FormInput.add(InputA);
        InputA.setBounds(170, 810, 40, 23);

        jLabel95.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel95.setText("A");
        jLabel95.setName("jLabel95"); // NOI18N
        FormInput.add(jLabel95);
        jLabel95.setBounds(160, 810, 20, 23);

        jLabel96.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel96.setText("   - Kontrasepsi yang pernah digunakan :");
        jLabel96.setName("jLabel96"); // NOI18N
        FormInput.add(jLabel96);
        jLabel96.setBounds(20, 750, 210, 23);

        TglPertamaMens.setForeground(new java.awt.Color(50, 70, 50));
        TglPertamaMens.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "29-08-2023" }));
        TglPertamaMens.setDisplayFormat("dd-MM-yyyy");
        TglPertamaMens.setName("TglPertamaMens"); // NOI18N
        TglPertamaMens.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TglPertamaMensActionPerformed(evt);
            }
        });
        FormInput.add(TglPertamaMens);
        TglPertamaMens.setBounds(180, 840, 90, 22);

        jLabel97.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel97.setText("   - Hari perkiraan lahir            :");
        jLabel97.setName("jLabel97"); // NOI18N
        FormInput.add(jLabel97);
        jLabel97.setBounds(20, 870, 160, 23);

        HariPerkiraanLahir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "29-08-2023" }));
        HariPerkiraanLahir.setDisplayFormat("dd-MM-yyyy");
        HariPerkiraanLahir.setName("HariPerkiraanLahir"); // NOI18N
        FormInput.add(HariPerkiraanLahir);
        HariPerkiraanLahir.setBounds(180, 870, 90, 22);

        jLabel98.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel98.setText("      7. Pemeriksaan dalam    :");
        jLabel98.setName("jLabel98"); // NOI18N
        FormInput.add(jLabel98);
        jLabel98.setBounds(20, 1210, 150, 23);

        UmurKehamilan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "29-08-2023" }));
        UmurKehamilan.setDisplayFormat("dd-MM-yyyy");
        UmurKehamilan.setName("UmurKehamilan"); // NOI18N
        FormInput.add(UmurKehamilan);
        UmurKehamilan.setBounds(180, 900, 90, 22);

        jLabel100.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel100.setText("   - Palpasi");
        jLabel100.setName("jLabel100"); // NOI18N
        FormInput.add(jLabel100);
        jLabel100.setBounds(20, 1010, 160, 23);
        ...
        FormInput.add(InputG);
        InputG.setBounds(50, 810, 40, 23);
        ...
        scrollPane2.setBounds(170, 1210, 330, 50);

        jLabel41.setText("Keadaan Umum :");
        jLabel41.setName("jLabel41"); // NOI18N
        FormInput.add(jLabel41);
        jLabel41.setBounds(0, 1330, 127, 23);
        ...
        Keadaan1.setBounds(130, 1330, 120, 23);
        ...
        FormInput.add(GCS);
        GCS.setBounds(335, 1330, 60, 23);

        jLabel28.setText("GCS(E,V,M) :");
        jLabel28.setName("jLabel28"); // NOI18N
        FormInput.add(jLabel28);
        jLabel28.setBounds(260, 1330, 70, 23);

        jLabel15.setText("TB :");
        jLabel15.setName("jLabel15"); // NOI18N
        FormInput.add(jLabel15);
        jLabel15.setBounds(565, 1300, 30, 23);
        ...
        FormInput.add(TB);
        TB.setBounds(598, 1300, 45, 23);

        jLabel24.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel24.setText(" cm");
        jLabel24.setName("jLabel24"); // NOI18N
        FormInput.add(jLabel24);
        jLabel24.setBounds(640, 1300, 30, 23);

        jLabel12.setText("BB :");
        jLabel12.setName("jLabel12"); // NOI18N
        FormInput.add(jLabel12);
        jLabel12.setBounds(670, 1300, 30, 23);
        ...
        FormInput.add(BB);
        BB.setBounds(703, 1300, 45, 23);

        jLabel13.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel13.setText("Kg");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(750, 1300, 30, 23);

        jLabel22.setText("TD :");
        jLabel22.setName("jLabel22"); // NOI18N
        FormInput.add(jLabel22);
        jLabel22.setBounds(0, 1300, 50, 23);
        ...
        FormInput.add(TD);
        TD.setBounds(55, 1300, 76, 23);

        jLabel23.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel23.setText("mmHg");
        jLabel23.setName("jLabel23"); // NOI18N
        FormInput.add(jLabel23);
        jLabel23.setBounds(135, 1300, 50, 23);

        jLabel17.setText("Nadi :");
        jLabel17.setName("jLabel17"); // NOI18N
        FormInput.add(jLabel17);
        jLabel17.setBounds(180, 1300, 40, 23);
        ...
        FormInput.add(Nadi);
        Nadi.setBounds(223, 1300, 45, 23);

        jLabel16.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel16.setText("x/menit");
        jLabel16.setName("jLabel16"); // NOI18N
        FormInput.add(jLabel16);
        jLabel16.setBounds(270, 1300, 50, 23);

        jLabel26.setText("RR :");
        jLabel26.setName("jLabel26"); // NOI18N
        FormInput.add(jLabel26);
        jLabel26.setBounds(310, 1300, 40, 23);
        ...
        FormInput.add(RR);
        RR.setBounds(353, 1300, 45, 23);

        jLabel25.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel25.setText("x/menit");
        jLabel25.setName("jLabel25"); // NOI18N
        FormInput.add(jLabel25);
        jLabel25.setBounds(400, 1300, 50, 23);

        jLabel18.setText("Suhu :");
        jLabel18.setName("jLabel18"); // NOI18N
        FormInput.add(jLabel18);
        jLabel18.setBounds(450, 1300, 40, 23);
        ...
        FormInput.add(Suhu);
        Suhu.setBounds(490, 1300, 45, 23);

        jLabel20.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel20.setText("°C");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(540, 1300, 30, 23);

        jLabel39.setText("Kesadaran :");
        jLabel39.setName("jLabel39"); // NOI18N
        FormInput.add(jLabel39);
        jLabel39.setBounds(400, 1330, 70, 23);
        ...
        Kesadaran.setBounds(473, 1330, 130, 23);

        jLabel40.setText("Kepala :");
        jLabel40.setName("jLabel40"); // NOI18N
        FormInput.add(jLabel40);
        jLabel40.setBounds(0, 1360, 127, 23);
        ...
        Kepala.setBounds(130, 1360, 120, 23);

        jLabel42.setText("Mata :");
        jLabel42.setName("jLabel42"); // NOI18N
        FormInput.add(jLabel42);
        jLabel42.setBounds(0, 1390, 127, 23);
        ...
        FormInput.add(Mata);
        Mata.setBounds(130, 1390, 120, 23);

        jLabel44.setText("Hidung :");
        jLabel44.setName("jLabel44"); // NOI18N
        FormInput.add(jLabel44);
        jLabel44.setBounds(0, 1420, 127, 23);
        ...
        FormInput.add(Gigi);
        Gigi.setBounds(130, 1420, 120, 23);

        jLabel45.setText("Gigi & Mulut :");
        jLabel45.setName("jLabel45"); // NOI18N
        FormInput.add(jLabel45);
        jLabel45.setBounds(0, 1450, 127, 23);
        ...
        FormInput.add(THT);
        THT.setBounds(130, 1450, 120, 23);

        jLabel46.setText("Tenggorokan :");
        jLabel46.setName("jLabel46"); // NOI18N
        FormInput.add(jLabel46);
        jLabel46.setBounds(0, 1480, 127, 23);
        ...
        Thoraks.setBounds(130, 1480, 120, 23);

        jLabel47.setText("Telinga :");
        jLabel47.setName("jLabel47"); // NOI18N
        FormInput.add(jLabel47);
        jLabel47.setBounds(0, 1510, 127, 23);
        ...
        Jantung.setBounds(130, 1510, 120, 23);

        jLabel53.setText("Leher :");
        jLabel53.setName("jLabel53"); // NOI18N
        FormInput.add(jLabel53);
        jLabel53.setBounds(270, 1360, 95, 23);
        ...
        FormInput.add(Paru);
        Paru.setBounds(370, 1360, 128, 23);

        jLabel49.setText("Thoraks :");
        jLabel49.setName("jLabel49"); // NOI18N
        FormInput.add(jLabel49);
        jLabel49.setBounds(270, 1390, 95, 23);
        ...
        Abdomen.setBounds(370, 1390, 128, 23);

        jLabel50.setText("Jantung :");
        jLabel50.setName("jLabel50"); // NOI18N
        FormInput.add(jLabel50);
        jLabel50.setBounds(270, 1420, 95, 23);
        ...
        Genital.setBounds(370, 1420, 128, 23);

        jLabel51.setText("Paru :");
        jLabel51.setName("jLabel51"); // NOI18N
        FormInput.add(jLabel51);
        jLabel51.setBounds(270, 1450, 95, 23);
        ...
        Ekstremitas.setBounds(370, 1450, 128, 23);

        jLabel52.setText("Abdomen :");
        jLabel52.setName("jLabel52"); // NOI18N
        FormInput.add(jLabel52);
        jLabel52.setBounds(270, 1480, 95, 23);
        ...
        FormInput.add(Kulit);
        Kulit.setBounds(370, 1480, 128, 23);

        Kulit1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Normal", "Abnormal", "Tidak Diperiksa" }));
        ...
        FormInput.add(Kulit1);
        Kulit1.setBounds(370, 1510, 128, 23);

        jLabel54.setText("Genitalia & Anus :");
        jLabel54.setName("jLabel54"); // NOI18N
        FormInput.add(jLabel54);
        jLabel54.setBounds(270, 1510, 95, 23);

        jLabel48.setText("Ekstremitas :");
        jLabel48.setName("jLabel48"); // NOI18N
        FormInput.add(jLabel48);
        jLabel48.setBounds(0, 1540, 127, 23);

        Jantung1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Normal", "Abnormal", "Tidak Diperiksa" }));
        Jantung1.setName("Jantung1"); // NOI18N
        Jantung1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Jantung1KeyPressed(evt);
            }
        });
        FormInput.add(Jantung1);
        Jantung1.setBounds(130, 1540, 120, 23);

        label1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        label1.setText("Skor :");
        label1.setName("label1"); // NOI18N
        FormInput.add(label1);
        label1.setBounds(180, 1810, 40, 20);
        ...
        textBox1.setBounds(105, 1900, 60, 24);
        ...
        label6.setBounds(0, 1930, 100, 20);
        ...
        scrollPane3.setBounds(105, 1930, 300, 50);

        jLabel202.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel202.setText("VIII. PEMERIKSAAN PENUNJANG TERAKHIR");
        jLabel202.setName("jLabel202"); // NOI18N
        FormInput.add(jLabel202);
        jLabel202.setBounds(10, 1870, 380, 23);
        ...
        FormInput.add(panelisi2);
        panelisi2.setBounds(20, 2010, 490, 60);
        ...
        label8.setBounds(0, 2105, 120, 20);
        ...
        FormInput.add(ResEmosi);
        ResEmosi.setBounds(115, 2105, 100, 20);

        label9.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        label9.setText("        - Support suami/keluarga :");
        label9.setName("label9"); // NOI18N
        FormInput.add(label9);
        label9.setBounds(0, 2130, 170, 20);
        ...
        FormInput.add(SupportSuami);
        SupportSuami.setBounds(165, 2130, 140, 20);
        ...
        jSeparator14.setBounds(0, 2160, 880, 1);

        jLabel204.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel204.setText("X. DATA PSIKOSOSIAL");
        jLabel204.setName("jLabel204"); // NOI18N
        FormInput.add(jLabel204);
        jLabel204.setBounds(10, 2080, 380, 23);

        panelisi3.setName("panelisi3"); // NOI18N
        panelisi3.setLayout(null);

        cekBox1.setText("Risiko perdarahan");
        cekBox1.setName("cekBox1"); // NOI18N
        cekBox1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cekBox1ActionPerformed(evt);
            }
        });
        panelisi3.add(cekBox1);
        cekBox1.setBounds(80, 30, 110, 17);

        cekBox3.setText("Nyeri");
        cekBox3.setName("cekBox3"); // NOI18N
        cekBox3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cekBox3ActionPerformed(evt);
            }
        });
        panelisi3.add(cekBox3);
        cekBox3.setBounds(10, 10, 60, 17);

        cekBox4.setText("Cemas");
        cekBox4.setName("cekBox4"); // NOI18N
        cekBox4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cekBox4ActionPerformed(evt);
            }
        });
        panelisi3.add(cekBox4);
        cekBox4.setBounds(10, 30, 60, 17);

        cekBox5.setText("Perubahan nutrisi");
        ...
        panelisi3.add(cekBox5);
        cekBox5.setBounds(80, 10, 110, 17);
        ...
        panelisi3.add(cekBox7);
        cekBox7.setBounds(200, 10, 70, 17);

        cekBox8.setText("Pengetahuan/Komunikasi/Informasi");
        ...
        panelisi3.add(cekBox8);
        cekBox8.setBounds(200, 30, 200, 17);
        ...
        panelisi3.add(textBox2);
        textBox2.setBounds(470, 10, 150, 24);

        FormInput.add(panelisi3);
        panelisi3.setBounds(20, 2180, 630, 60);
        ...
        scrollPane4.setBounds(10, 2270, 400, 70);
...
//        Valid.pindah(evt,Alergi,Kesadaran);
    ...
    private void TglPertamaMensActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TglPertamaMensActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_TglPertamaMensActionPerformed
    ...
    private void KontrasepsiLainnyaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_KontrasepsiLainnyaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_KontrasepsiLainnyaActionPerformed
    ...
    private void PengkajianOleh1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PengkajianOleh1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_PengkajianOleh1KeyPressed

    private void CaraDatangLainnya3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CaraDatangLainnya3ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_CaraDatangLainnya3ActionPerformed
...
//        Valid.pindah(evt,Ekstremitas,KetFisik);
    ...
    private void Jantung1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Jantung1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_Jantung1KeyPressed
    ...
    private void cekBox3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cekBox3ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cekBox3ActionPerformed

    private void cekBox4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cekBox4ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cekBox4ActionPerformed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMAsesmenAwalKebidananIGDOld dialog = new RMAsesmenAwalKebidananIGDOld(new javax.swing.JFrame(), true);
    ...
    private widget.TextBox CaraDatangLainnya3;
    ...
    private widget.Tanggal HariPerkiraanLahir;
    private widget.CekBox Hepatitis;
    private widget.TextBox HubuganDenanPasien;
    ...
    private widget.ComboBox Jantung1;
    ...
    private widget.TextBox MenggunakanLainnya1;
    ...
    private widget.ComboBox PengkajianOleh1;
    ...
    private widget.Tanggal TglPertamaMens;
    ...
    private widget.Tanggal UmurKehamilan;
    private widget.TextBox UsiaHamil;
    private widget.CekBox cekBox1;
    private widget.CekBox cekBox2;
    private widget.CekBox cekBox3;
    private widget.CekBox cekBox4;
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            CaraDatang.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),12).toString()); 
            Menggunakan.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),13).toString()); 
            CaraMasuk.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),14).toString());
            FrekAukultasi.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),107).toString()); 
            PresentasiJanin.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),108).toString());
            LetakPunggungJanin.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),110).toString());
