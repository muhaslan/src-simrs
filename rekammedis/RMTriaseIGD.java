...
public final class RMTriaseIGD extends javax.swing.JDialog {
    ...
    public RMTriaseIGD(java.awt.Frame parent, boolean modal) {
        ...
        ChkAccorCttn.setSelected(false);
        isCttn();
    }
    ...
    private void initComponents() {
        ...
        ChkAccorCttn = new widget.CekBox();
        TabData = new javax.swing.JTabbedPane();
        FormCttnPeriksa = new widget.PanelBiasa();
        ...
        PrimerTanggalTriase.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "26-06-2023 21:38:40" }));
        ...
        SekunderTanggalTriase.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "26-06-2023 21:38:43" }));
        ...
        TanggalKunjungan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "26-06-2023 21:38:43" }));
        ...
        ChkAccorCttn.setBackground(new java.awt.Color(255, 250, 248));
        ChkAccorCttn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/kiri.png"))); // NOI18N
        ChkAccorCttn.setSelected(true);
        ChkAccorCttn.setFocusable(false);
        ChkAccorCttn.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        ChkAccorCttn.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        ChkAccorCttn.setName("ChkAccorCttn"); // NOI18N
        ChkAccorCttn.setPreferredSize(new java.awt.Dimension(15, 20));
        ChkAccorCttn.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/kiri.png"))); // NOI18N
        ChkAccorCttn.setRolloverSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/kanan.png"))); // NOI18N
        ChkAccorCttn.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/kanan.png"))); // NOI18N
        ChkAccorCttn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ChkAccorCttnActionPerformed(evt);
            }
        });
        PanelAccorCttn.add(ChkAccorCttn, java.awt.BorderLayout.WEST);
        ...
        FormCttnPeriksa.setBackground(new java.awt.Color(255, 255, 255));
        FormCttnPeriksa.setBorder(null);
        FormCttnPeriksa.setName("FormCttnPeriksa"); // NOI18N
        FormCttnPeriksa.setPreferredSize(new java.awt.Dimension(115, 73));
        FormCttnPeriksa.setLayout(new java.awt.BorderLayout(1, 1));
        ...
        Scroll10.setViewportView(HasilPeriksa);

        FormCttnPeriksa.add(Scroll10, java.awt.BorderLayout.CENTER);
        ...
        FormCttnPeriksa.add(panelGlass6, java.awt.BorderLayout.PAGE_END);

        TabData.addTab("Catatan Pemeriksaan", FormCttnPeriksa);

        PanelAccorCttn.add(TabData, java.awt.BorderLayout.CENTER);

        FormTriase.add(PanelAccorCttn, java.awt.BorderLayout.EAST);
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(tbTriase.getSelectedRow()!= -1){
                if(akses.getkode3().equals("Admin Utama")){
                    ...
                    if(akses.getkode2().equals(kodepetugas)){
                        hapus();
                    }else{
    ...
    private void ChkAccorCttnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkAccorCttnActionPerformed
    ...
    }//GEN-LAST:event_ChkAccorCttnActionPerformed
...
//        }
            if(HasilPeriksa.getText().equals("")){
                Sequel.queryu2("delete from cttn_igdtriase where no_rawat=?",1,new String[]{
                    TNoRw.getText()
                });
            }else{
                if(Sequel.menyimpantf2("cttn_igdtriase","?,?,?","Catatan Periksa",3,new String[]{
                    TNoRw.getText(),Valid.SetTgl(TanggalKunjungan.getSelectedItem()+"")+" "+TanggalKunjungan.getSelectedItem().toString().substring(11,19),HasilPeriksa.getText()
                })==false){
                    Sequel.queryu2("update cttn_igdtriase set hasil=? where no_rawat=?",2,new String[]{
                        HasilPeriksa.getText(),TNoRw.getText()
                    });
                }
            }
            JOptionPane.showMessageDialog(null,"Proses Update Selesai...!");
...
//        tampilOrthanc();
    ...
    */
    ...
    private widget.CekBox ChkAccorCttn;
    private widget.Tanggal DTPCari1;
    private widget.Tanggal DTPCari2;
    private widget.PanelBiasa FormCttnPeriksa;
    ...
    public void isCek(){
        ...
        if(akses.getjml2()>=1){
            btnPrimerPetugas.setEnabled(true);
            btnSekunderPetugas.setEnabled(true);
            PrimerKodePetugas.setText(akses.getkode2());
            SekunderKodePetugas.setText(akses.getkode2());
    ...
    private void isCttn(){
//        if(ChkAccorCttn.isSelected()==true){
//            ChkAccorCttn.setVisible(false);
//            PanelAccorCttn.setPreferredSize(new Dimension(470,WIDTH));
//            FormCttnPeriksa.setVisible(true);  
//            ChkAccorCttn.setVisible(true);
//        }else if(ChkAccorCttn.isSelected()==false){
//            ChkAccorCttn.setVisible(false);
//            PanelAccorCttn.setPreferredSize(new Dimension(15,WIDTH));
//            FormCttnPeriksa.setVisible(false);
//            ChkAccorCttn.setVisible(true);
//            System.out.println("ini blok false");
//        }
        if(ChkAccorCttn.isSelected()==true){
            ChkAccorCttn.setVisible(false);
            ...
            if(!TNoRM.getText().equals("")){
                try {
                    ps4=koneksi.prepareStatement(
                            "select cttn_igdtriase.hasil from cttn_igdtriase where no_rawat=?");
                    try {
                        ps4.setString(1,TNoRw.getText());
                        rs4=ps4.executeQuery();
                        if(rs4.next()){
                            HasilPeriksa.setText(rs4.getString(1));
                        }else{
