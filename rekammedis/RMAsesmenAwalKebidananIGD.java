...
public final class RMAsesmenAwalKebidananIGD extends javax.swing.JDialog {
    ...
    public RMAsesmenAwalKebidananIGD(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            // header
            "No.Rawat","No.RM","Nama Pasien","Tgl.Lahir","J.K.","Tanggal Asuhan","NIP Pengkaji","Nama Pengkaji","NIP DPJP","Nama DPJP","Cara Datang","Menggunakan","Dari","Pengkajian Diperoleh Dari","Alasan Masuk",
            // riwayat kesehatan
            "Penyakit yang Diderita","Riwayat  Penyakit","Faktor Keturunan Gemelli","Ketergantungan","Alergi Obat-Obatan","Alergi Makanan","Alergi Debu","Alergi Lainnya",
            // riwayat obstetri
            "Menarche","Menstruasi","Siklus","Sakit Saat Menstruasi","Menikah yang ke","Lamanya Pernikahan","Kontrasepsi yang pernah digunakan","Lamanya",
            // data kehamilan
            "Graphite","Paritas","Abortus","Hari Pertama Haid Terakhir","Hari Perkiraan Lahir","Umur Kehamilan","Keluhan Kehamilan Saat Ini",
            "Tinggi Fundus Uteri","Letak Punggung Janin","Presentasi Janin","Taksiran Berat Janin","Penurunan","Aukultasi","Frekuensi Aukultasi","Pemeriksaan Dalam",
            // pemeriksaan fisik
            "TD","Nadi","RR","Suhu","TB","BB","Keadaan Umum","GCS","Kesadaran","Kepala","Mata","Hidung","Gigi & Mulut","Tenggorokan","Telinga","Ekstremitas","Leher","Thoraks","Jantung","Paru","Abdomen","Genitalia & Anus",
            ...
            "Status Mental",
            // data psikososial
            "Respon Emosi","Suport Suami/Keluarga",
            // Diagnosa kebidanan
            "Diagnosa Kebidanan"
        }){
...
//                        NmPetugas2.setText(petugas.getTable().getValueAt(petugas.getTable().getSelectedRow(),2).toString());  
    ...
    private void initComponents() {
        ...
        BtnKeluarKehamilan.setBounds(320, 140, 100, 30);
        ...
        BtnSimpanRiwayatKehamilan.setBounds(210, 140, 100, 30);
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-09-2023 01:30:50" }));
        ...
        panelInputan.add(TglPertamaMens);
        TglPertamaMens.setBounds(180, 570, 90, 22);
        ...
        panelInputan.add(HariPerkiraanLahir);
        HariPerkiraanLahir.setBounds(180, 600, 90, 22);
        ...
        UmurKehamilan.setBounds(180, 630, 90, 22);
    ...
    private void BtnSimpanRiwayatKehamilanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanRiwayatKehamilanActionPerformed
        if(UmurAnak.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("riwayat_persalinan","?,?,?,?,?,?,?","Riwayat Persalinan",7,new String[]{
                    TNoRM.getText(),UmurAnak.getText(),KUAnak.getText(),RiwayatPersalinan.getText(),DitolongOleh.getText(),JK.getSelectedItem().toString().substring(0,1),BBL.getText()
                })==true){
                emptTeksPersalinan();
                tampilPersalinan();
            }
        ...
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if(Keluhan.getText().trim().equals("")){
                ...
                if(Sequel.menyimpantf("ponek_non_partus","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",88,new String[]{
                    ...
                    // section 4
                    InputG.getText(),InputP.getText(),InputA.getText(),Valid.SetTgl(TglPertamaMens.getSelectedItem()+""),Valid.SetTgl(HariPerkiraanLahir.getSelectedItem()+""),Valid.SetTgl(UmurKehamilan.getSelectedItem()+""),
                    Keluhan.getText(),
                    // section 4.1
...
//        Valid.pindah(evt,Alergi,Kesadaran);
    ...
    private void BtnHapusRiwayatPersalinanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusRiwayatPersalinanActionPerformed
        if(tbRiwayatKehamilan.getSelectedRow()>-1){
            Sequel.meghapus("riwayat_persalinan","no_rkm_medis",TNoRM.getText());
            tampilPersalinan();
        }else{
            JOptionPane.showMessageDialog(rootPane,"Silahkan anda pilih data terlebih dahulu..!!");
        }
...
//    }
    ...
    private void tampil(){
        ...
        try {
            ...
            try{
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        rs.getString("no_rawat"),rs.getString("no_rm_medis"),rs.getString("nm_pasien"),rs.getString("tgl_lahir"),rs.getString("jk"),rs.getString("tanggal"),rs.getString("kd_petugas"),rs.getString("nm_petugas"),rs.getString("kd_dpjp"),rs.getString("nm_dpjp"),
                        ...
                        rs.getString("menstruasi"),rs.getString("sejak_menstruasi"),rs.getString("sakit_saat_menstruasi"),rs.getString("menikah_ke"),rs.getString("lamanya_pernikahan"),rs.getString("kontrasepsi"),
    ...
    public void emptTeks() {
        ...
        InputP.setText("");
        InputA.setText("");
        TglPertamaMens.setDate(new Date());
        HariPerkiraanLahir.setDate(new Date());
        UmurKehamilan.setDate(new Date());
        Keluhan.setText("");
...
//            Sequel.cariIsi("select reg_periksa.tgl_registrasi from reg_periksa where reg_periksa.no_rawat='"+norwt+"'", DTPCari1);
            ...
            Menggunakan.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),11).toString());
            ...
            CaraMasuk.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),12).toString());
            DariLainnya.setText(Sequel.cariIsi("select ponek_non_partus.menggunakan_lainnya from ponek_non_partus where ponek_non_partus.no_rawat=?",tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()));
            PengkajianOleh.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),13).toString());
            ...
            Menarche.setText(tbObat.getValueAt(tbObat.getSelectedRow(),22).toString());
            Menstruasi.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),23).toString());
            HariMens.setText(tbObat.getValueAt(tbObat.getSelectedRow(),24).toString());
            SakitSaatMens.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),25).toString());
            Menikahke.setText(tbObat.getValueAt(tbObat.getSelectedRow(),26).toString());
            LamanyaMenikah.setText(tbObat.getValueAt(tbObat.getSelectedRow(),27).toString());
            NmKontrasepsi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),28).toString());
            KontrasepsiLamanya.setText(tbObat.getValueAt(tbObat.getSelectedRow(),28).toString());
            InputG.setText(tbObat.getValueAt(tbObat.getSelectedRow(),29).toString());
            InputP.setText(tbObat.getValueAt(tbObat.getSelectedRow(),30).toString());
            InputA.setText(tbObat.getValueAt(tbObat.getSelectedRow(),31).toString());
            TglPertamaMens.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),32));
            HariPerkiraanLahir.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),33));
            UmurKehamilan.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),34));
            Keluhan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),35).toString());
            TinggiFundus.setText(tbObat.getValueAt(tbObat.getSelectedRow(),36).toString());
            LetakPunggungJanin.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),37));
            PresentasiJanin.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),38));
            BeratJanin.setText(tbObat.getValueAt(tbObat.getSelectedRow(),39).toString());
            Penurunan.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),40));
            Aukultasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),41).toString());
            FrekAukultasi.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),42));
            PemeriksaanDalam.setText(tbObat.getValueAt(tbObat.getSelectedRow(),43).toString());
            TD.setText(tbObat.getValueAt(tbObat.getSelectedRow(),44).toString());
            Nadi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),45).toString());
            RR.setText(tbObat.getValueAt(tbObat.getSelectedRow(),46).toString());
            Suhu.setText(tbObat.getValueAt(tbObat.getSelectedRow(),47).toString());
            TB.setText(tbObat.getValueAt(tbObat.getSelectedRow(),48).toString());
            BB.setText(tbObat.getValueAt(tbObat.getSelectedRow(),49).toString());
            Keadaan1.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),50));
            GCS.setText(tbObat.getValueAt(tbObat.getSelectedRow(),51).toString());
            Kesadaran.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),52));
            // disini input penurunan kesadaran
            Kepala.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),53));
            Mata.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),54));
            Hidung.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),55));
            GigiMulut.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),56));
            Tenggorokan.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),57));
            Telinga.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),58));
            Ekstremitas.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),59));
            Leher.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),60));
            Thoraks.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),61));
            Jantung.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),62));
            Paru.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),63));
            Abdomen.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),64));
            Anus.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),65));
            Nyeri.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),66));
            SkorNyeri.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),67));
            KategoriNyeri.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),68));
            PengaruhNyeri.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),69));
            HB.setText(tbObat.getValueAt(tbObat.getSelectedRow(),70).toString());
            HasilUSG.setText(tbObat.getValueAt(tbObat.getSelectedRow(),71).toString());
            String status_mental = tbObat.getValueAt(tbObat.getSelectedRow(),72).toString();
            ...
            ResEmosi.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),73).toString());
            SupportSuami.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),74).toString());
            String masalah_kebidanan = tbObat.getValueAt(tbObat.getSelectedRow(),75).toString();
    ...
    private void getMasalah() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            DiagnosaKebidanan1.setText(tbObat.getValueAt(tbObat.getSelectedRow(),76).toString());
