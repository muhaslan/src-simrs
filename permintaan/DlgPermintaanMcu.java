...
public final class DlgPermintaanMcu extends javax.swing.JDialog {
    ...
    private PreparedStatement pstindakan,pstindakan2,pstindakan3,pstindakan4,pstampil,pstampil1,
            psset_tarif;
    private ResultSet rstindakan,rstampil,rsset_tarif,rstampil1;
    private boolean[] pilih,pilih2; 
    private String[] kode,nama,pemeriksaan2,satuan2,nilai_rujukan2,idtemplate2,idpemeriksaan2;
    ...
    public DlgPermintaanMcu(java.awt.Frame parent, boolean modal) {
        ...
        PanelCariUtama1.setVisible(false);
        PanelCariUtama2.setVisible(false);

        Object[] row={
            "P","Pemeriksaan","Satuan","Nilai Rujukan","id_template","Jenis Pemeriksaan","kd_jenis_prw"};
...
//             column.setPreferredWidth(356);
    ...
    private void initComponents() {
        ...
        TanggalPA.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-07-2023" }));
        ...
        TanggalBahan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-07-2023" }));
    ...
    */
    ...
    private void tampil() { 
        try {
            ...
            idpemeriksaan2=null;
            idpemeriksaan2=new String[jml2];
            ...
            for(i2=0;i2<tbDetailPK.getRowCount();i2++){
                if(tbDetailPK.getValueAt(i2,0).toString().equals("true")){
                    ...
                    idpemeriksaan2[index2]=tbDetailPK.getValueAt(i2,5).toString();
                    index2++;
                }
            }
            ...
            for(i2=0;i2<jml2;i2++){ 
                tabMode.addRow(new Object[] {
                    pilih2[i2],pemeriksaan2[i2],satuan2[i2],nilai_rujukan2[i2],idtemplate2[i2],idpemeriksaan2[i2]
                });
            }  
...
//                    tabMode.addRow(new Object[]{false,tbTarifPK.getValueAt(i2,2).toString(),"","",""});
                    pstampil=koneksi.prepareStatement("select jns_perawatan_mcu.nm_perawatan,jns_perawatan_mcu.jns_perawatan,jns_perawatan_mcu.kd_jenis_prw from jns_perawatan_mcu where jns_perawatan_mcu.kd_paket_mcu=?");
...
//                        pstampil.setString(2,"%"+TCari.getText().trim()+"%");
                        ...
                        while(rstampil.next()){
                            String jns_perawatan = "";
                            if(rstampil.getString(2).equals("NON LABORATORIUM")){
                               jns_perawatan = rstampil.getString(2)+" (Radiologi)";
                            }else{
                                jns_perawatan = rstampil.getString(2);
                            }
                            tabMode.addRow(new Object[]{false,"   "+rstampil.getString(1),"","","",jns_perawatan,rstampil.getString(3)});
                            ...
                            try{
                                pstampil1.setString(1,rstampil.getString(3));
//                                pstampil.setString(2,"%"+TCari.getText().trim()+"%");
                                rstampil1=pstampil1.executeQuery();
                                while(rstampil1.next()){
                                    la="";ld="";pa="";pd="";
                                    if(!rstampil1.getString("nilai_rujukan_ld").equals("")){
                                        ld="LD : "+rstampil1.getString("nilai_rujukan_ld");
                                    }
                                    if(!rstampil1.getString("nilai_rujukan_la").equals("")){
                                        la=", LA : "+rstampil1.getString("nilai_rujukan_la");
                                    }
                                    if(!rstampil1.getString("nilai_rujukan_pa").equals("")){
                                        pd=", PD : "+rstampil1.getString("nilai_rujukan_pd");
                                    }
                                    if(!rstampil1.getString("nilai_rujukan_pd").equals("")){
                                        pa=" PA : "+rstampil1.getString("nilai_rujukan_pa");
                                    }
                                    tabMode.addRow(new Object[]{
                                        false,"   "+"   "+rstampil1.getString("Pemeriksaan"),
                                         rstampil1.getString("satuan"),"  "+
                                         ld+la+pd+pa,
                                         rstampil1.getString("id_template")
                                    });
                                }
                            }catch(Exception e){
            ...
            try {                    
                ...
                if(jml>0){
                    if(Sequel.menyimpantf2("permintaan_mcu","?,?,?,?,?,?,?,?,?,?,?,?","No.Permintaan",12,new String[]{
                        ...
                        for(i=0;i<tbTarifPK.getRowCount();i++){ 
                            if(tbTarifPK.getValueAt(i,0).toString().equals("true")){
                                Sequel.menyimpan2("permintaan_pemeriksaan_paketmcu","?,?","pemeriksaan mcu",2,new String[]{
...
//                            }                        
//                        }
                        // tampung data dari table tbDetailPK dan masukkan ke database
                        for(i=0;i<tbDetailPK.getRowCount();i++){
                            if((!tbDetailPK.getValueAt(i,4).toString().equals(""))&&tbDetailPK.getValueAt(i,0).toString().equals("true")){
                                    Sequel.menyimpan2("permintaan_detail_permintaan_mcu","?,?,?,?,?,?","Detail MCU",6,new String[]{
                                        TNoPermintaanPK.getText(),
                                        Sequel.cariIsi("select template_mcu.kd_paket_mcu from template_mcu where template_mcu.id_template=?",tbDetailPK.getValueAt(i,4).toString()),
                                        Sequel.cariIsi("select template_mcu.kd_jenis_prw from template_mcu where template_mcu.id_template=?",tbDetailPK.getValueAt(i,4).toString()),
