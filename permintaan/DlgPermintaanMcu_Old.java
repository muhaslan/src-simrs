 ...
 * @author dosen
 */
public final class DlgPermintaanMcu_Old extends javax.swing.JDialog {
...
//    private String[] kd_pemeriksaan,nm_pemeriksaan,jns_pemeriksaan;
     ...
     * @param parent
     * @param modal */
    public DlgPermintaanMcu_Old(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPermintaanMcu_Old dialog = new DlgPermintaanMcu_Old(new javax.swing.JFrame(), true);
