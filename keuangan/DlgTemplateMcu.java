 ...
 * @author dosen
 */
public final class DlgTemplateMcu extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgTemplateMcu(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Object[] row={"Pemeriksaan","Satuan","N.Rujukan L.D.","N.Rujukan L.A.","N.Rujukan P.D.",
                      "N.Rujukan P.A.","Biaya Item","Paket BHP","J.M. Perujuk","J.M. Dokter",
        ...
        for (int i = 0; i < 16; i++) {
            ...
            }else if((i==14)||(i==15)||(i==7)||(i==8)||(i==9)||(i==10)||(i==11)||(i==12)||(i==13)){
    ...
    private void initComponents() {
        ...
        KdPeriksa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                KdPeriksaActionPerformed(evt);
            }
        });
        ...
        NmPeriksa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                NmPeriksaActionPerformed(evt);
            }
        });
             ...
             if(row>-1){
                 for(int i=0;i<row;i++){  
                    ...
                    if(tbKamar.getValueAt(i,14).toString().equals("")){
                         Sequel.menyimpan("template_mcu","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Id Hasil Periksa",18,new String[]{
                               ...
                               tbKamar.getValueAt(i,15).toString(),NmPeriksa.getText()       
                         });
                    }else if(!tbKamar.getValueAt(i,14).toString().equals("")){
                         Sequel.mengedit("template_mcu","id_template=?","Pemeriksaan=?,satuan=?,nilai_rujukan_ld=?,nilai_rujukan_la=?,"+
...
private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
   try{
       Sequel.meghapus("template_mcu","id_template",tbKamar.getValueAt(tbKamar.getSelectedRow(),14).toString());
    ...
    private void NmPeriksaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NmPeriksaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_NmPeriksaActionPerformed

    private void KdPeriksaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_KdPeriksaActionPerformed
        // TODO add your handling code here:
        KdPeriksa.setVisible(false);
    }//GEN-LAST:event_KdPeriksaActionPerformed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgTemplateMcu dialog = new DlgTemplateMcu(new javax.swing.JFrame(), true);
    ...
    public void tampil() {
        ...
        try{            
            ps=koneksi.prepareStatement("select id_template, Pemeriksaan, satuan, nilai_rujukan_ld, nilai_rujukan_la, nilai_rujukan_pd,"+
                        ...
                        "from template_mcu where kd_jenis_prw=? order by urut");
            try {
