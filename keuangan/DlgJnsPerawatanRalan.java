...
public final class DlgJnsPerawatanRalan extends javax.swing.JDialog {
    ...
    public DlgJnsPerawatanRalan(java.awt.Frame parent, boolean modal) {
        ...
        // komponen hide        
        TJmlPr.setVisible(false);
        jLabel11.setVisible(false);
        TTndPr.setVisible(false);
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Total Biaya Dokter Sp : Rp.");
        jLabel10.setName("jLabel10"); // NOI18N
        FormInput.add(jLabel10);
        jLabel10.setBounds(367, 162, 155, 23);
        ...
        TJmlDr.setBounds(525, 162, 200, 23);

        jLabel11.setText("Total Biaya Pr : Rp.");
        jLabel11.setName("jLabel11"); // NOI18N
        FormInput.add(jLabel11);
        jLabel11.setBounds(730, 40, 130, 23);
        ...
        TJmlPr.setBounds(870, 40, 200, 23);
        ...
        jLabel13.setBounds(730, 100, 130, 23);
        ...
        TTndPr.setBounds(860, 100, 200, 23);
        ...
        jLabel14.setBounds(372, 132, 150, 23);
        ...
        TJmlDrPr.setBounds(525, 132, 200, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            Sequel.menyimpan("jns_perawatan","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Kode Tarif",15,new String[]{
                ...
                "0",KSO.getText(),Menejemen.getText(),TJmlDr.getText(),"0",TJmlDrPr.getText(),
        ...
        if(TKd.getText().trim().equals("")){
            ...
            Sequel.mengedit("jns_perawatan","kd_jenis_prw=?","kd_jenis_prw=?,nm_perawatan=?,kd_kategori=?,material=?,"+
                    "tarif_tindakandr=?,tarif_tindakanpr=?,total_byrdr=?,total_byrpr=?,kd_pj=?,kd_poli=?,total_byrdrpr=?,bhp=?,kso=?,menejemen=?",15,new String[]{
                        TKd.getText(),TNm.getText(),KdKtg.getText(),BagianRs.getText(),TTndDr.getText(),"0",TJmlDr.getText(),"0",
